        ...
        while (true)
        {
            ...
            switch(int.Parse(Console.ReadLine()))
            {
                case 1:
                {
                    ...
                    System.Console.WriteLine("Trainee IDs: " + string.Join(",", traineeIDs));
                    break;
                }
                case 2:
                {
                    ...
                    System.Console.WriteLine("First 3 Trainee IDs: " + string.Join(",", firstThreeTraineeIDs));
                    break;
                }
                case 3:
                {
                    ...
                    System.Console.WriteLine("Last 2 Trainee IDs: " + string.Join(",", lastTwoTraineeIDs));
                    break;
                }
                case 4:
                {
                    ...
                    System.Console.WriteLine("Number of Trainees: " + traineeCount);
                    break;
                }
                case 5:
                {
                ...
                {            
                    ...
                    System.Console.WriteLine("Enter trainee ID to get total marks:");
                ...
                {            
                    ...
                    if(firstTainee!=null)
                    {
                        System.Console.WriteLine($"First Trinee: {firstTainee.TraineeId} - {firstTainee.TraineeName}");
                    }
                    break;
                }
                case 11:
                {            
                    ...
                    if(lastTainee!=null)
                    {
                        System.Console.WriteLine($"First Trinee: {lastTainee.TraineeId} - {lastTainee.TraineeName}");
                    }
                    break;
                }
                case 12:
